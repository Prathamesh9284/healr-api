...
print("Firebase DB URL:", firebase_db_url)
print("Groq Key:", groq_key)

# # Ensure JSON parsing works
# firebase_credentials_dict = json.loads(firebase_credentials)
# print("Parsed Firebase Credentials:", firebase_credentials_dict)
...
# Debugging to confirm Firebase initialization
...
diabetesfull = joblib.load(r'models/diabetesfull.pkl')
diabeteshalf = joblib.load(r'models/diabeteshalf.pkl')
hypertensionfull = joblib.load(r'models/hypertensionfull.pkl')
hypertensionhalf = joblib.load(r'models/hypertensionhalf.pkl')
